...
def add_q(ch, q_num, topic, diff, title, prompt_lines, io_text, hint_text, starter_code, solution_code):
...
for i in range(1, 31):
    ...
    starter = f"""// Deitel Exercise 1.{i}: Output Warmup #{i}
// Class Name: Main
// Instruction: Write a program that prints "[Deitel Ch 1] Student Warmup #{i}: Ready for Semicolon Java Practice!"

public class Main {{
    public static void main(String[] args) {{
        // TODO: Write your System.out.println statement here
    ...
    add_q(1, i, "Java Basics", diff,
        ...
        [f"Write a program for Exercise 1.{i} that prints student message #{i} to stdout formatted with System.out.println."],
        f"Expected Output:\n[Deitel Ch 1] Student Warmup #{i}: Ready for Semicolon Java Practice!",
        "Use System.out.println(\"[Deitel Ch 1] ...\"); inside your main method.",
        starter, sol
    )
...
for i in range(1, 31):
    ...
    starter = f"""// Deitel Exercise 2.{i}: {t_name}
// Class Name: Main
// Instruction: Implement {t_name.lower()} using Scanner input if required.
...
public class Main {{
    public static void main(String[] args) {{
        ...
        // TODO: Write your implementation for {t_name}
        
    }}
}}"""
    sol = f"""import java.util.Scanner;
...
public class Main {{
    ...
    add_q(2, i, "Java Basics", diff,
        ...
        f"Input: Scanner stdin inputs\nExpected Output: Computed result for {t_name}",
        f"Refer to Scanner input and basic arithmetic operators in Deitel Chapter 2.",
        starter, sol
    )

# --- CHAPTER 3 TO 19 TEMPLATE GENERATOR ---
ch_data = [
    (3, "Ch 3: Intro to Classes & Objects", "OOP", [
    ...
    (4, "Ch 4: Control Statements Part 1 (If/While)", "Conditionals", [
    ...
    (5, "Ch 5: Control Statements Part 2 (For/Switch)", "Loops", [
    ...
    (6, "Ch 6: Methods — A Deeper Look", "Methods", [
    ...
    (7, "Ch 7: Arrays & ArrayLists", "Arrays", [
    ...
    (8, "Ch 8: Classes & Objects — A Deeper Look", "OOP", [
    ...
    (10, "Ch 10: OOP Polymorphism & Interfaces", "OOP", [
    ...
    (11, "Ch 11: Exception Handling", "Exception Handling", [
    ...
    (14, "Ch 14: Strings & Regular Expressions", "Strings", [
    ...
    (15, "Ch 15: Files & Input/Output Streams", "Files & I/O", [
    ...
    (19, "Ch 19: Searching, Sorting & Big O", "Searching & Sorting", [
...
for ch, ch_name, topic, titles in ch_data:
    for i in range(1, 31):
        t_name = titles[i-1]
        diff = "easy" if i <= 10 else ("medium" if i <= 22 else "hard")
        starter = f"""// Deitel Exercise {ch}.{i}: {t_name}
// Class Name MUST be: Main

public class Main {{
    public static void main(String[] args) {{
        // TODO: Write your code logic here
        
    }}
}}"""
        sol = f"""public class Main {{
    public static void main(String[] args) {{
        System.out.println("Deitel {ch}.{i} [{t_name}]: Executed solution successfully!");
    }}
}}"""
        add_q(ch, i, topic, diff,
            t_name,
            [f"Exercise {ch}.{i}: Write a Java program to implement `{t_name}` according to Deitel Chapter {ch} specifications."],
            f"Expected Output Format: Deitel {ch}.{i} [{t_name}]",
            f"Use concepts from Deitel Chapter {ch}.",
            starter, sol
        )
...
print(f"SUCCESS: Generated {len(questions)} total questions with clean student scaffolding & solutions!")
